#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Quote-pair walker — Arc V (adapted from QA/quote_pair_check.py). Read-only.
Output: QA/arc5_tooling/a5_quote_pairs.txt"""
import re, io, os, sys
sys.stdout = io.TextIOWrapper(sys.stdout.buffer, encoding="utf-8")
BASE = os.path.dirname(os.path.dirname(os.path.dirname(os.path.abspath(__file__))))
CH = os.path.join(BASE, "content", "story", "chapters")
OUT = os.path.join(os.path.dirname(os.path.abspath(__file__)), "a5_quote_pairs.txt")
