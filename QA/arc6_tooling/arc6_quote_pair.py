#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Arc VI — quote pair check (adapted from QA/quote_pair_check.py). Read-only."""
import re, io, sys, os
...
out = open(os.path.join(TOOL_DIR, "arc6_quote_pair.txt"), "w", encoding="utf-8")
def p(*a):
...
out.close()
print("written: arc6_quote_pair.txt")
