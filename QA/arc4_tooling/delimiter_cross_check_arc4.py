# -*- coding: utf-8 -*-
"""Arc IV crossed-delimiter detector — adapted from QA/delimiter_cross_check.py."""
import re, io, sys, os
...
out = open(os.path.join(TOOL_DIR, "delimiter_cross_check_arc4.txt"), "w", encoding="utf-8")
def p(*a):
