...
| arc7-03 | The Ancient one | 🟡 pending v4 [2026-09-04] — self-audit PASS (coil beat: wurm rings bind torso, head+shoulders above; closed pincer mandibles at face level; regalia restored v4; sepia ink + palest cold tint; v1-v3 drifts archived) | `chapter-arc7-03-v4.png` | 7,370,825 | 2026-09-04 |
