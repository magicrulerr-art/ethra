...
| arc7-03 | The Ancient one | 🟡 pending v8 [2026-09-04] — Ainz rejected v6 (no constriction); v8 = gigant wurm coiled in tall spiral CONSTRICTING the hidden king (only fur-mantle scrap + golden tail-tip visible, Ajani not shown per ruling), eardless armored dome head, closed pincer mandibles; band re-cut from v8, css v41 | `chapter-arc7-03-v8.png` | 7,065,887 | 2026-09-04 |
