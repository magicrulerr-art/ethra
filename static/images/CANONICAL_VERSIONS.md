...
| arc7-03 | The Ancient one | 🟡 pending v6 [2026-09-04] — Ainz ex-post on v4: scale + cat-face corrections; v5 fixed both but lion grammar leaked to wurm head; v6 self-audit PASS (one coil head-to-toe at 20m-vs-2m scale, eardless plated head, closed mandibles, lion-pharaoh Ajani, regalia) | `chapter-arc7-03-v6.png` | 6,913,230 | 2026-09-04 |
