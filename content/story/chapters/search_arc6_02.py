...
with open('C:/Users/magic_new.BETOS-AIO.000/.qwenpaw/workspaces/default/ethra_site/content/story/chapters/chapter-arc6-02.md', 'r', encoding='utf-8') as f:
    content = f.read()
...
for pattern in patterns:
    ...
    if matches:
        ...
        print(f'NOT FOUND in arc6-02: "{pattern}"')