...
print("=== P5 Verification for Arc6-01 ===\n")
...
# 2. Zero "Humman" tokens (should be "Human" now)
print("\n2. Humman tokens:")
humman_count = 0
for i, line in enumerate(lines):
    if 'Humman' in line:
...
# 5. No asterisk-thoughts (lines with *text* not **Header**)
print("\n5. Asterisk-thoughts:")
asterisk_count = 0
for i, line in enumerate(lines):
    stripped = line.strip()
