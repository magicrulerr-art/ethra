#!/usr/bin/env python3
"""
P2 Mechanical Mapping for Arc6-02:
- M1: Humman -> Human (all variants)
- M2: King -> king (standalone, not Ice King/Shadow King)
...
# M1: Humman variants -> Human variants
original = content
...
# M4: debris -> wreckage in lines 350-400 (1-based)
